                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('update.about') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="short_title" value="{{ $aboutpage->short_title }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <!-- <input class="form-control" type="text" name="short_description" value="{{ $aboutpage->short_description }}"> -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <!-- <input class="form-control" type="text" name="long_description" value="{{ $aboutpage->long_description }}"> -->
