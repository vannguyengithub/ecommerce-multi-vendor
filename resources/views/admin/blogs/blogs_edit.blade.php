                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('update.blog') }}" enctype="multipart/form-data">
                            ...
                            <input class="form-control" type="hidden" name="id" value="{{ $blogs->id }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="blog_tags" value="{{ $blogs->blog_tags }}" data-role="tagsinput">
                                </div>
                            </div>
