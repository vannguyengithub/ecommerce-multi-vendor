                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('update.blog.category') }}">
                            ...
                            <input class="form-control" type="hidden" name="id" value="{{ $blogcategory->id }}">

                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Blog Category</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="blog_category" value="{{ $blogcategory->blog_category }}">
                                    @error('blog_category')
